              ...
              if ($module.ModuleOwnersGHTeam -eq $ghTeam.name) {
                  ...
                  if ($testOwner -match "Success") {
                    ...
                    $unmatchedTeam = [PSCustomObject]@{
                        ...
                        Resolution     = "Please assign the correct owners permissions to the team: [$($ghTeam.name)]. This can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
                    }
                  ...
                  if ($ValidateBicepParentConfiguration -and $matchFound) {
                      ...
                      if (-not $null -eq $ghTeam.parent -and $ValidateBicepParentConfiguration) {
                          ...
                          $unmatchedTeam = [PSCustomObject]@{
                              ...
                              Owner          = "$($module.PrimaryModuleOwnerGHHandle) ($($module.PrimaryModuleOwnerDisplayName))"
                              GitHubTeamName = $ghTeam.name
                              Resolution     = "Assign the correct parent team to the team: $($module.ModuleOwnersGHTeam) [here](https://github.com/orgs/zojovano/teams/$($module.ModuleContributorsGHTeam)). Parent information can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
                          }
                          # Add the custom object to the array
                          $unmatchedTeams += $unmatchedTeam
                          break
                      ...
                      if ($module.ModuleOwnersGHTeam -like "*-tf") {
                          ...
                          if ($repoConfiguration -match "Success") {
                              ...
                              $unmatchedTeam = [PSCustomObject]@{
                                  ...
                                  Owner          = "$($module.PrimaryModuleOwnerGHHandle) ($($module.PrimaryModuleOwnerDisplayName))"
                                  GitHubTeamName = $ghTeam.name
                                  Resolution     = "Please assign the correct permissions to the team: $($module.ModuleOwnersGHTeam). This can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
                              }
                              # Add the custom object to the array
                              $unmatchedTeams += $unmatchedTeam
                              break
                  ...
                  if ($ValidateBicepParentConfiguration -and $matchFound) {
                      ...
                      if (-not $null -eq $ghTeam.parent -and $ValidateBicepParentConfiguration) {
                          ...
                          $unmatchedTeam = [PSCustomObject]@{
                              ...
                              Owner          = "$($module.PrimaryModuleOwnerGHHandle) ($($module.PrimaryModuleOwnerDisplayName))"
                              GitHubTeamName = $ghTeam.name
                              Resolution     = "Assign the correct parent team to the team: $($module.ModuleContributorsGHTeam) [here](https://github.com/orgs/zojovano/teams/$($module.ModuleContributorsGHTeam)). Parent information can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
                          }
                          # Add the custom object to the array
                          $unmatchedTeams += $unmatchedTeam
                      }
                      ...
                      if ($module.ModuleContributorsGHTeam -like "*-tf") {
                          ...
                          if ($repoConfiguration -match "Success") {
                              ...
                              $unmatchedTeam = [PSCustomObject]@{
                                  ...
                                  Owner          = "$($module.PrimaryModuleOwnerGHHandle) ($($module.PrimaryModuleOwnerDisplayName))"
                                  GitHubTeamName = $ghTeam.name
                                  Resolution     = "Please assign the correct permissions to the team: $($module.ModuleContributorsGHTeam). This can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
                              }
                              # Add the custom object to the array
                              $unmatchedTeams += $unmatchedTeam
                              break
          ...
          if ($module.ModuleOwnersGHTeam -like "*-tf") {
            ...
            if ($teamTest -match "Success") {
              ...
              $unmatchedTeam = [PSCustomObject]@{
                  ...
                  Resolution     = "Please assign the correct permissions to the team: [$tfAdminteam]. This can be found in [SNFR20](https://zojovano.github.io/azure-verified-modules-copy/spec/SNFR20)."
              }
              # Add the custom object to the array
              $unmatchedTeams += $unmatchedTeam
              break
