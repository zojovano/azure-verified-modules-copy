...
- {{% icon icon="fa-brands fa-github" %}} To see the **full, unfiltered, unformatted module index** on GitHub, click [here](https://github.com/zojovano/azure-verified-modules-copy/blob/main/docs/static/module-indexes/BicepPatternModules.csv).
